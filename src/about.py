...
def about_app():
    ...
    **Tecnologías Utilizadas**
    ...
    - **Bibliotecas de Datos**: Pandas, NumPy, Matplotlib para la manipulación y visualización de datos.
    ...
    **Instrucciones de Uso**
    ...
    - **Resultados**:("Queda pendiente actualizar al final con lo que podamos filtrar") La aplicación mostrará gráficos interactivos y tablas con los datos analizados.
    - **Alertas y Recomendaciones**: ("Queda pendiente actualizar al final con lo que podamos filtrar").
